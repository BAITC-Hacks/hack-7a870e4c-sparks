...
import { formatUserCreatedDate, getUserDisplayName } from "../lib/user.utils";
import { USER_ROLES } from "../model/user.constants";
 ...
 *
 * Принимает колбэки действий (onEdit/onDelete/onView) — это интерактивный
 * листовой компонент, поэтому он клиентский ("use client").
 */
